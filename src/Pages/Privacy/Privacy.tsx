...
const Privacy = () => {
  return (
    <>
      ...
      >
        <div className=" overlap-gap-section m-100px">
          <p className="paragraph">Last updated: June 06, 2024</p>
          ...
          <h2 className="head">Interpretation and Definitions</h2>
          ...
          <ul>
            ...
            <li className="list">
              <p className="paragraph">
                ...
                in this Agreement) refers to Vibes Lanka Travels and Tours PVT
                (Ltd), No 126 , Galle Road , Colombo 06 , Sri Lanka .
              </p>
            </li>
            <li className="list">
              <p className="paragraph">
            ...
            <li className="list">
              <p className="paragraph">
                <strong>Website</strong> refers to Vibes Lanka , accessible from{" "}
                <a
                  href="http://vibeslanka.com/"
          ...
          <h2 className="head">Collecting and Using Your Personal Data</h2>
          ...
          <ul>
            ...
            <li className="list">
              <p className="paragraph">First name and last name</p>
            </li>
            <li className="list">
              <p className="paragraph">Phone number</p>
            </li>
            <li className="list">
              <p className="paragraph">Address, State, Province, ZIP/Postal code, City</p>
            </li>
            <li className="list">
          ...
          <ul>
            <li className="list">
              ...
              <p className="paragraph">Type: Session Cookies</p>
              <p className="paragraph">Administered by: Us</p>
              <p className="paragraph">
            ...
            <li className="list">
              ...
              <p className="paragraph">Type: Persistent Cookies</p>
              <p className="paragraph">Administered by: Us</p>
              <p className="paragraph">
          ...
          <ul>
            <li className="list">Comply with a legal obligation</li>
            <li className="list">Protect and defend the rights or property of the Company</li>
            <li className="list">
            ...
            <li className="list">Protect against legal liability</li>
          </ul>
          ...
          <h2 className="head">Children's Privacy</h2>
          <p className="paragraph">
          ...
          <h2 className="head">Links to Other Websites</h2>
          <p className="paragraph">
          ...
          <h2 className="head">Changes to this Privacy Policy</h2>
          <p className="paragraph">
          ...
          <ul>
            <li className="list">
              <p className="paragraph">By email: info@vibeslanka.com</p>
            </li>
            <li className="list">
              <p className="paragraph">
            ...
            <li className="list">
              <p className="paragraph">By phone number: +94 76 708 5151</p>
            </li>
            <li className="list">
              <p className="paragraph">By mail: No 126,Galle Road, Colombo 06, Sri Lanka</p>
            </li>
          </ul>
        </div>
      </section>
